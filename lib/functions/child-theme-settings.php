...
class Child_Theme_Settings extends Genesis_Admin_Boxes {
	...
	function __construct() {
		...
		$default_settings = array(
			...
			'footer-right' => 'Site by <a href="http://www.delputnam.com">Del Putnam</a>',
		);
 ...
 * @since 1.0.0
 */
function dp_add_child_theme_settings() {
	global $_child_theme_settings;
	$_child_theme_settings = new Child_Theme_Settings;
}
add_action( 'genesis_admin_menu', 'dp_add_child_theme_settings' );
